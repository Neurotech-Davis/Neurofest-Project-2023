...
screenDisplay = (width_screen, height_screen) = (1920, 1080)
FPS = 60
gravity = 0.6
...
pygame.display.set_caption("Dino Run - Davis Edition")

soundOnJump = pygame.mixer.Sound('resources/jump.wav')
soundOnDie = pygame.mixer.Sound('resources/die.wav')
soundOnCheckpoint = pygame.mixer.Sound('resources/Cow 9 sound effect -23Cow -23sound -23effect.mp3')
...
class Cactus(pygame.sprite.Sprite):
    def __init__(self, speed=10, sx=-1, sy=-1):
